...
Our parser provides additional check that asserting the input document to be a \FIXML 4.4 Schema version and not just any well-formed XML document or \FXIML DTD version.
