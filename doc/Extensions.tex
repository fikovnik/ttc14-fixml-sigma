...
Despite the fact that C is not an object oriented language, our organization of the M2T transformation templates makes the implementation only 36 lines longer (30\%) than the C++ version.
